<template>
  <form @submit.prevent style="width: 240px; margin: 2em auto;" autocomplete="off">
    <BaseTextField
        label="Name"
...
import { BaseTextField, BaseButton, BaseSelect, BaseAutocomplete } from '@/components'
