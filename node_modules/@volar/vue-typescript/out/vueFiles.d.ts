...
export declare function createVueFiles(): {
    ...
    fromEmbeddedLocation: (fileName: string, start: number, end?: number, filter?: ((data: EmbeddedFileMappingData) => boolean) | undefined, sourceMapFilter?: ((sourceMap: EmbeddedFileSourceMap) => boolean) | undefined) => Generator<{
        fileName: string;
        range: {
            start: number;
            end: number;
